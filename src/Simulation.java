...
public class Simulation {
        ...
        do {
            ...
            try {
                ...
                switch (choix) {
                    ...
                    case 6 -> displayWalletValue(scanner, market, currentPlayer);
                    case 7 -> {
    ...
    private static void addStock(Scanner scanner, Market market) {
        ...
        // Ajouter au market
        if (market.addMarketStock(new Stock(symbol, name, price))){
    ...
    private static void removeStock(Scanner scanner, Market market) {
        ...
        // Ajouter au market
        if (market.removeMarketStock(symbol)){
    ...
    public static void displayWalletValue(Scanner scanner, Market market, Player player){
        Portfolio portfolio = player.getPortfolio();
        portfolio.printTotalValue(market);
    }
}